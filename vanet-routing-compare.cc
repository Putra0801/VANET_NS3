...
VanetRoutingExperiment::ConfigureTracing ()
{
  ...
  AsciiTraceHelper ascii;
  MobilityHelper::EnableAsciiAll (ascii.CreateFileStream (m_trName + ".tr"));
}
...
VanetRoutingExperiment::Run ()
{
  ...
  Simulator::Run ();
  flowmon->SerializeToXmlFile (("hasil.flowmon"), true, true);
  Simulator::Destroy ();
}
...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  if (m_scenario == 1)
    ...
    {
      // Realistic vehicular trace in Telkom University, Kab. Bandung.
      // "low density, 138 total vehicles"
      m_traceFile = "/home/dyan/tubes_modsim.tcl";
      m_logFile = "tubes_modsim.log";
      m_mobility = 1;
      m_nNodes = 138;
      m_TotalSimTime = 100.01;
      m_nodeSpeed = 30000;
      m_nodePause = 0;
      m_CSVfileName = "tubes_modsim_vanet-routing-compare.csv";
    }
}
